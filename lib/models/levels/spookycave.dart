...
class SpookyCave extends Level {
  ...
  List<String> section2 = [
    ...
    "ĞĞĞĞĞĞĞgggaaaaaaaaaafgggg",
    "aaaaaaaggaaagagagagaggggg",
    "aaaaaaagaagaaaaaaaaaaaagg",
    "aaaaaaaaaggaaaaaaaaaaaa!!",
    "ĞgggggabĞĞĞĞĞĞĞĞggggaaggĞ",
    "aaaaaaagaaaaaaaagggaaagga",
    "a1ababggaaaaaaaagaaaaggga",
  ...
  List<String> section3 = [
    ...
    "ggaaaggggIggIgggggggĞĞĞĞĞ",
    "gggaaaagIaggagIIgIgaaaaaa",
    "ggggaaaIaagIaIaagaiaaaaaa",
    "!!!!aaaaaaIaaaaagaaaaaaaa",
